...
export const PART = definePart(
  ...
  {
    'compare.current': 'Joriy',
    'compare.comparison': 'Taqqoslash',
    'compare.length': 'Tana uzunligi',
    'compare.metamorphosis': 'Metamorfoz',
    'compare.diet': 'Ovqatlanishi',
    'compare.switchTitle': "Taqqoslanadigan turni almashtirish",
    'compare.closeLabel': 'Taqqoslashni yopish',

    'notes.title': 'Kuzatuv qaydlari',
    'notes.recordedCount': '{n} ta tur qayd etildi',
    'notes.subtitleEmpty': "O'zingiz ko'rgan narsalarni yozib qo'ying",
    'notes.placeholder': "{name} haqidagi kuzatuvni yozing: qachon, qayerda, nimani ko'rdingiz",
    'notes.hint': "Matnni tozalash bu qaydni o'chiradi",
    'notes.save': 'Saqlash',
    'notes.emptyList': "Hali qaydlar yo'q. Birinchisini yuqorida yozing — u shu qurilmada saqlanadi.",

    'library.title': 'Hasharotlar jildi',
    'library.showAllTitle': 'Barcha turlarni ko\'rsatish',
    'library.notedOnlyTitle': "Faqat qayd etilganlarni ko'rsatish ({n} ta)",
    'library.clearFilterTitle': 'Filtrni tozalash',
    'library.emptyNoted': "Hali qayd etilgan tur yo'q",
    'library.emptyFiltered': "Bu filtr bo'yicha tur topilmadi",
    'library.viewAll': 'Barcha {n} ta turni ko\'rish',
  },
)
