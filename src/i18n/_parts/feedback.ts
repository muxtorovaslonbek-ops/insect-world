...
export const PART = definePart(
  ...
  {
    'photo.credit': 'Muallif: {name}',
    'photo.alt': '{name}ning haqiqiy fotosurati',
    'photo.more': "Ko'proq fotosuratlar",

    'wall.open': "Odamlar nimani ko'rmoqchi",
    'wall.title': "Odamlar nimani ko'rmoqchi",
    'wall.sub': "Ovoz bering yoki biror narsa yozing",
    'wall.vote': 'Ovoz berish',
    'wall.voted': 'Ovoz berildi',
    'wall.votes': '{n} ovoz',
    'wall.wishOwn': 'Men ham buni ko\'rmoqchiman…',
    'wall.featuredTitle': 'Tahrir tanlagan bir nechtasi',
    'wall.loading': 'Yuklanmoqda…',
    'wall.offline': "Devor hozircha ishlamayapti, birozdan so'ng qayta urinib ko'ring.",
    'wall.retry': "Qayta urinish",

    'feedback.correction.open': "Bu yerda xato bormi?",
    'feedback.correction.title': "Bu yerda xato bormi?",
    'feedback.correction.sub': "Nima noto'g'ri ekanini ayting, biz tekshiramiz",
    'feedback.correction.about': '{name} haqida',
    'feedback.correction.placeholder': "Nimasi noto'g'ri? Qanchalik aniq bo'lsa, shunchalik yaxshi — masalan, «orqa qanotning dumi juda qisqa»",
    'feedback.wish.title': 'Men ham buni ko\'rmoqchiman…',
    'feedback.wish.placeholder': "Qaysi hasharotni yoki qanday funksiyani ko'rishni xohlaysiz?",

    'feedback.email': 'Elektron pochta',
    'feedback.emailPlaceholder': "Ixtiyoriy — qoldirsangiz javob beramiz (bir necha kun ketishi mumkin)",
    'feedback.emailHint': "Faqat javob berish uchun ishlatiladi, hech qachon ko'rsatilmaydi.",
    'feedback.privacy': "Xabarlar avtomatik e'lon qilinmaydi — faqat biz devor uchun tanlasak, chop etiladi.",
    'feedback.submit': 'Yuborish',
    'feedback.sending': 'Yuborilmoqda…',
    'feedback.cancel': 'Bekor qilish',
    'feedback.thanks': "Qabul qilindi, rahmat.",
    'feedback.thanksAgain': "Yana bir narsa ayting",
    'feedback.err.invalid': "Formada biror joy noto'g'ri to'ldirilgan. Tekshirib, qayta yuboring.",
    'feedback.err.rate': "Bugun juda ko'p yuborildi, ertaga qayta urinib ko'ring.",
    'feedback.err.net': "Yuborilmadi. Birozdan so'ng qayta urinib ko'ring.",
  },
)
